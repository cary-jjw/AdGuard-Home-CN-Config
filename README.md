...
再附送一个[DoH 阿里国密版本 ] https://sm2.doh.pub/dns-query    最好的 quic://223.5.5.5:853  推荐使用
...
如果你是小内存设备 建议使用 秋风 名单小，但命中率高。 秋风官网地址 https://awavenue.top/ 

最后如果你只想对国内网站进行屏蔽  请在自定义过滤规则 填写 ||cn.ntp.org.cn^$dnsrewrite=NXDOMAIN
